...
def main(args):
    ...
    result_dic = DG.rolling_validation(Ymat = Ymat,tau=9,n=160,bsize=100,cpu=False,alpha=0.3)
    print(result_dic)

    out_path = Path('/efs/users/rajatse/DeepGLOv2','results','result_dictionary_pems_' + bool2str(normalize) + '.pkl')
